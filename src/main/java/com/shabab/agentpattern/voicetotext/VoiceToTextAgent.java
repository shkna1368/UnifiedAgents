...
public String startMeeting(String filePath) throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
 ...
 mediaList.add(media);;
    ...
    public String startSignLanguage(String filePath) throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        String prompt= """
     "
                You are an assistant that converts spoken Persian language into Persian Sign Language (PSL)-friendly text for deaf people.
                
                Your task:
                - Take the transcribed spoken Persian text.
                - Rewrite it into the natural grammar, structure, and style of Persian Sign Language.
                - Keep only the essential words needed to convey meaning.
                - Follow PSL word order: usually Subject-Object-Verb, but remove filler words and auxiliary verbs unless necessary for meaning.
                - Keep meaning and tense accurate.
                - Avoid polite forms and unnecessary particles like "لطفاً", "خواهش می‌کنم", "می‌شود که", unless needed.
                
                Example:
                Input (spoken Persian): "سلام، میشه لطفاً بگی جلسه امروز چه ساعتی شروع میشه؟"
                Output (PSL-friendly Persian): "سلام امروز جلسه چه ساعت شروع؟"
